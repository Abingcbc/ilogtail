...
public:
    ...
    bool Collect(const HostMonitorTimerEvent::CollectContext& collectContext, PipelineEventGroup* group) {
...
private:
    ...
    std::unordered_map<std::string, std::unordered_map<std::string, CollectorInstance>> mRegisteredCollectorMap;
